...
namespace SchoolAppAPI.Controllers
{
    ...
    public class MarksController : ControllerBase
    {
        ...
        public MarksController(SchoolAppContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> PutMark(int id, Mark mark)
        {
            ...
            if (mark.StaffId != null && !await _context.Staffs.AnyAsync(s => s.StaffId == mark.StaffId))
            {
        ...
        public async Task<ActionResult<Mark>> PostMark(Mark mark)
        {
            ...
            {
                // Check if the provided StaffId exists in the database
                var existingStaff = await _context.Staffs.FindAsync(mark.StaffId);
