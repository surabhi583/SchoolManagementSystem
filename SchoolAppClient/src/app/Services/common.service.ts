...
export class CommonServices {
  ...
  private apiUrl3 = 'https://localhost:44350/api/Common';
  private apiUrl2 = 'https://localhost:44350/api/Common/Frequency';
  ...
  getDueBalance(studentId: number): Observable<DueBalance> {
    return this.http.get<DueBalance>(`https://localhost:44350/api/Common/DueBalances/${studentId}`);
  }
