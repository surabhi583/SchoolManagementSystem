...
namespace SchoolAppCore.Migrations
{
    ...
    [Migration("20240819081257_20240819151020_MIG")]
    partial class _20240819151020_MIG
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchoolAppModels.DataModels.AcademicMonth", b =>
                {
            ...
            modelBuilder.Entity("SchoolAppModels.DataModels.AcademicYear", b =>
                {
            ...
            modelBuilder.Entity("SchoolAppModels.DataModels.Attendance", b =>
                {
            ...
            modelBuilder.Entity("SchoolAppModels.DataModels.Department", b =>
                {
            ...
            modelBuilder.Entity("SchoolAppModels.DataModels.DueBalance", b =>
                {
            ...
            modelBuilder.Entity("SchoolAppModels.DataModels.ExamSchedule", b =>
                {
            ...
            modelBuilder.Entity("SchoolAppModels.DataModels.ExamScheduleStandard", b =>
                {
            ...
            modelBuilder.Entity("SchoolAppModels.DataModels.ExamSubject", b =>
                {
            ...
            modelBuilder.Entity("SchoolAppModels.DataModels.ExamType", b =>
                {
                    b.Property<int>("ExamTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SchoolAppModels.DataModels.Fee", b =>
                {
            ...
            modelBuilder.Entity("SchoolAppModels.DataModels.FeeType", b =>
                {
                    b.Property<int>("FeeTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SchoolAppModels.DataModels.Mark", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Feedback = "Good job!",
                            Grade = 1,
                            MarkEntryDate = new DateTime(2024, 8, 19, 13, 42, 53, 831, DateTimeKind.Local).AddTicks(6868),
                            ObtainedScore = 65,
                            PassMarks = 40,
                            PassStatus = 0,
                            StaffId = 1,
                        ...
                        new
                        {
                            ...
                            Grade = 0,
                            MarkEntryDate = new DateTime(2024, 8, 19, 13, 42, 53, 831, DateTimeKind.Local).AddTicks(6872),
                            ObtainedScore = 75,
                            PassMarks = 40,
                            PassStatus = 0,
                            StaffId = 2,
                        ...
                        new
                        {
                            ...
                            Feedback = "Excellent work!",
                            Grade = 0,
                            MarkEntryDate = new DateTime(2024, 8, 19, 13, 42, 53, 831, DateTimeKind.Local).AddTicks(6876),
                            ObtainedScore = 75,
                            PassMarks = 40,
                            PassStatus = 0,
                            StaffId = 3,
            ...
            modelBuilder.Entity("SchoolAppModels.DataModels.MarkEntry", b =>
                {
            ...
            modelBuilder.Entity("SchoolAppModels.DataModels.MonthlyPayment", b =>
                {
                    b.Property<int>("MonthlyPaymentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SchoolAppModels.DataModels.OtherPaymentDetail", b =>
                {
            ...
            modelBuilder.Entity("SchoolAppModels.DataModels.OthersPayment", b =>
                {
                    b.Property<int>("OthersPaymentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SchoolAppModels.DataModels.PaymentDetail", b =>
                {
                    b.Property<int>("PaymentDetailId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SchoolAppModels.DataModels.PaymentMonth", b =>
                {
            ...
            modelBuilder.Entity("SchoolAppModels.DataModels.SecurityModels.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SchoolAppModels.DataModels.Staff", b =>
                {
                    b.Property<int>("StaffId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SchoolAppModels.DataModels.StaffExperience", b =>
                {
            ...
            modelBuilder.Entity("SchoolAppModels.DataModels.StaffSalary", b =>
                {
                    b.Property<int>("StaffSalaryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SchoolAppModels.DataModels.Standard", b =>
                {
                    b.Property<int>("StandardId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SchoolAppModels.DataModels.Student", b =>
                {
                    b.Property<int>("StudentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SchoolAppModels.DataModels.StudentMarksDetails", b =>
                {
                    b.Property<int>("StudentId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SchoolAppModels.DataModels.Subject", b =>
                {
                    b.Property<int>("SubjectId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SchoolAppModels.DataModels.SecurityModels.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SchoolAppModels.DataModels.AcademicMonth", b =>
                {
                    b.HasOne("SchoolAppModels.DataModels.MonthlyPayment", "monthlyPayment")
            ...
            modelBuilder.Entity("SchoolAppModels.DataModels.DueBalance", b =>
                {
                    b.HasOne("SchoolAppModels.DataModels.MonthlyPayment", null)
                        .WithMany("dueBalances")
                        .HasForeignKey("MonthlyPaymentId");

                    b.HasOne("SchoolAppModels.DataModels.Student", "Student")
                        .WithMany()
            ...
            modelBuilder.Entity("SchoolAppModels.DataModels.ExamScheduleStandard", b =>
                {
                    b.HasOne("SchoolAppModels.DataModels.ExamSchedule", "ExamSchedule")
                        .WithMany("ExamScheduleStandards")
                        .HasForeignKey("ExamScheduleId");

                    b.HasOne("SchoolAppModels.DataModels.Standard", "Standard")
                        .WithMany("ExamScheduleStandards")
            ...
            modelBuilder.Entity("SchoolAppModels.DataModels.ExamSubject", b =>
                {
                    b.HasOne("SchoolAppModels.DataModels.ExamScheduleStandard", "ExamScheduleStandard")
                        .WithMany("ExamSubjects")
                        .HasForeignKey("ExamScheduleStandardId");

                    b.HasOne("SchoolAppModels.DataModels.ExamType", "ExamType")
                        .WithMany("ExamSubjects")
                        .HasForeignKey("ExamTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SchoolAppModels.DataModels.Subject", "Subject")
                        .WithMany("ExamSubjects")
            ...
            modelBuilder.Entity("SchoolAppModels.DataModels.Fee", b =>
                {
                    b.HasOne("SchoolAppModels.DataModels.FeeType", "feeType")
                        .WithMany()
                    ...
                    b.HasOne("SchoolAppModels.DataModels.OthersPayment", "othersPayment")
                        .WithMany("fees")
            ...
            modelBuilder.Entity("SchoolAppModels.DataModels.Mark", b =>
                {
                    b.HasOne("SchoolAppModels.DataModels.Staff", "Staff")
                        .WithMany()
            ...
            modelBuilder.Entity("SchoolAppModels.DataModels.OtherPaymentDetail", b =>
                {
                    b.HasOne("SchoolAppModels.DataModels.OthersPayment", null)
            ...
            modelBuilder.Entity("SchoolAppModels.DataModels.Staff", b =>
                {
                    b.HasOne("SchoolAppModels.DataModels.Department", "Department")
                        .WithMany()
                        .HasForeignKey("DepartmentId");

                    b.HasOne("SchoolAppModels.DataModels.StaffSalary", "StaffSalary")
                        .WithMany()
            ...
            modelBuilder.Entity("SchoolAppModels.DataModels.StaffExperience", b =>
                {
                    b.HasOne("SchoolAppModels.DataModels.Staff", null)
            ...
            modelBuilder.Entity("SchoolAppModels.DataModels.StudentMarksDetails", b =>
                {
                    b.HasOne("SchoolAppModels.DataModels.MarkEntry", "MarkEntry")
