...
namespace SchoolAppCore.Migrations
{
    /// <inheritdoc />
    public partial class _20240819151020_MIG : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Good job!", 1, new DateTime(2024, 8, 19, 13, 42, 53, 831, DateTimeKind.Local).AddTicks(6868), 65, 40, 0, 1, 1, 1, 80 },
                    { 2, "Excellent work!", 0, new DateTime(2024, 8, 19, 13, 42, 53, 831, DateTimeKind.Local).AddTicks(6872), 75, 40, 0, 2, 2, 2, 90 },
                    { 3, "Excellent work!", 0, new DateTime(2024, 8, 19, 13, 42, 53, 831, DateTimeKind.Local).AddTicks(6876), 75, 40, 0, 3, 3, 3, 90 }
                });
